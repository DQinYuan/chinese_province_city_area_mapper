...
# 特点
 ...
 - 因为jieba分词本身有时候会分错，所以引入了全文匹配的模式，这种模式下能够提高准确率，但会导致性能降低，关于如何开启这个模式见下面的使用文档或者 [issue #11](https://github.com/DQinYuan/chinese_province_city_area_mapper/issues/11)
